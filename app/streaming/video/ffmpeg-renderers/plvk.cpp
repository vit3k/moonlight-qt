    ...
    for (int i = 0; i < Overlay::OverlayMax; i++) {
        ...
        if (m_Overlays[i].hasOverlay) {
            ...
            if (i == Overlay::OverlayStatusUpdate) {
                ...
                // Centered
                overlayParts[i].dst.x0 = (targetFrame.crop.x1 - targetFrame.crop.x0 - overlayParts[i].src.x1) / 2;
                overlayParts[i].dst.y0 = (targetFrame.crop.y1 - targetFrame.crop.y0 - overlayParts[i].src.y1) / 2;
            }
